...
# Database: lxcadmin
# Generation Time: 2018-04-06 05:03:31 +0000
# ************************************************************
...
VALUES
	('1','admin','de41b7fb99201d8334c23c014db35ecd92df81bc','lxc','1133671055321055258374707980945218933803269864762743594642571294','1','2018-04-06 08:37:12','0:0:0:0:0:0:0:1','0','admin','default','QQ1094921525@main.com','001','18101298728'),
...
INSERT INTO `tb_issuejob` (`ISSUEJOB_ID`, `JOB_TYPE_ID`, `JOB_MESSAGE_ID`, `COUNTS`, `PRINCIPAL`, `FOUNDTIME`)
VALUES
...
INSERT INTO `tb_mobilize` (`MOBILIZE_ID`, `EMP_ID`, `EMP_NAME`, `JOB_ID`, `JOB_TYPE_ID`, `CAUSE`, `STATUS`, `STAFFEMPLOYEE_ID`)
VALUES
...
INSERT INTO `tb_staffemployee` (`STAFFEMPLOYEE_ID`, `STAFF_ID`, `STAFF_NAME`, `SEX`, `ADDRESS`, `PHONE`, `PIC`, `CARD_ID`, `EMAIL`, `QQ`, `WECHAT`, `POST_CODE`, `GOVEMMET`, `NATION`, `LEARING`, `HOBBY`, `SUIT`, `NATIONALITY`, `BIRTH`, `FAITH`, `SPEIALITY`, `RESUME`, `DESCRIBES`, `REMARK`, `ISROMVE`, `JOB_ID`, `USER_ID`, `JOB_TYPE_ID`, `AGE`, `ADD_TIME`, `STIPEND_ID`, `CREATE_TIME`, `UPDATE_TIME`, `CREATE_USER`, `UPDATE_USER`, `STATES`, `DEPARTMENT_ID`)
VALUES
	('3e69e297070e42d7b46628317898013e',1001,'大乔',2,'北京市','111','2018032902014862900.jpg','128901920121','21212212@qq.com','1901290112','daqiao','1212','其他','0','硕士','英语','游泳','CN','1992-12-11','佛教','计算机','111','111','11',0,'3','1','1001A',21,'2018-01-25','1001',NULL,NULL,NULL,NULL,1,'0'),
	('497520f2ac994a0196796b1ac27a2f99',1009,'高爽',2,'黑龙江省五常市五常镇新曙光街七委二组','13611328766','2018033106485613627.JPG','232103197405070025','13611328766@qq.com','1361132876','13611328766','100091','其他','0','大学','逛街买卖','跳舞','CN','1974-05-07','无','资产管理','基本信息有效','基本信息有效','基本信息有效',0,'2737dbd2dfc24136a1ea2dccdc6905c5','admin','1004A',44,'2018-03-31',NULL,'2018-03-31 06:48:58','2018-03-31 06:48:58','admin','admin',0,'0'),
	...
	('f1c558ce3db2423e8e5dd1566839fe28',1006,'刘熙财',1,'北京市海淀区','18101298728','2018032911313148474.png','360732199306202118','12811212921@qq.com','1291290121','liuxicai002','10001','其他','3','本科','编程','书法','CN','10919291','佛教','计算机科学与技术','vvv','212121212','哈哈',0,'3','975','1001A',23,'2018-01-16','d7b60e8f222c46fb8e2d45caf9fe4542',NULL,NULL,NULL,NULL,1,'0');
...
# Dump of table tb_subpaper
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_subpaper`;

CREATE TABLE `tb_subpaper` (
...
# Dump of table tb_subpapermx
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_subpapermx`;

CREATE TABLE `tb_subpapermx` (
