...
-- 正在导出表  lxcadmin.sys_createcode 的数据：~9 rows (大约)
...
-- 正在导出表  lxcadmin.sys_lxcbutton 的数据：~8 rows (大约)
...
INSERT INTO `sys_menu` (`MENU_ID`, `MENU_NAME`, `MENU_URL`, `PARENT_ID`, `MENU_ORDER`, `MENU_ICON`, `MENU_TYPE`, `MENU_STATE`) VALUES
	...
	(82, '调动管理', 'mobilize/doSelectAll.do', '80', '1', 'menu-icon fa fa-leaf black', '1', 1),
...
-- 正在导出表  lxcadmin.sys_role_lxcbutton 的数据：~68 rows (大约)
...
INSERT INTO `sys_user` (`USER_ID`, `USERNAME`, `PASSWORD`, `NAME`, `RIGHTS`, `ROLE_ID`, `LAST_LOGIN`, `IP`, `STATUS`, `BZ`, `SKIN`, `EMAIL`, `NUMBER`, `PHONE`) VALUES
	('1', 'admin', 'de41b7fb99201d8334c23c014db35ecd92df81bc', 'lxc', '1133671055321055258374707980945218933803269864762743594642571294', '1', '2018-03-14 23:56:32', '127.0.0.1', '0', 'admin', 'default', 'QQ1094921525@main.com', '001', '18101298728'),
...
-- 正在导出表  lxcadmin.tb_job_message 的数据：~3 rows (大约)
...
-- 正在导出表  lxcadmin.tb_job_type 的数据：~2 rows (大约)
...
INSERT INTO `tb_staffemployee` (`STAFFEMPLOYEE_ID`, `STAFF_ID`, `SEX`, `ADDRESS`, `PHONE`, `PIC`, `CARD_ID`, `EMAIL`, `QQ`, `WECHAT`, `POST_CODE`, `GOVEMMET`, `NATION`, `LEARING`, `HOBBY`, `SUIT`, `NATIONALITY`, `BIRTH`, `FAITH`, `SPEIALITY`, `RESUME`, `DESCRIBES`, `REMARK`, `ISROMVE`, `JOB_ID`, `USER_ID`, `AGE`, `ADD_TIME`, `STIPEND_ID`, `CREATE_TIME`, `UPDATE_TIME`, `CREATE_USER`, `UPDATE_USER`, `STAFF_NAME`, `STATES`) VALUES
	('3e69e297070e42d7b46628317898013e', 11, 1, '北京市', '111', '', '128901920121', '21212212@qq.com', '1901290112', '2121', '1212', '2121', '2', '硕士', '英语', '游泳', 'CN', '1992-12-11', '佛教', '计算机', '111', '111', '11', 0, '2', 11, 11, '2018-01-25', 11, NULL, NULL, NULL, NULL, '张三丰', 1),
	('58d0c83404c447ec94354d044f489897', 1002, 2, '海南岛', '18911780490', '', '360732199202102113', '212819289@qq.com', '1094921521', '121211214', '3424223', '党员', '5', '研究生', '旅游', '绘画', 'CN', '1992-02-10', '佛教', '金融', '1122222222222222222', '11111111111', '', 0, '2', 10002, 26, '2018-01-22', 111, NULL, NULL, NULL, NULL, '古成芳', 1),
	('635f7ef8103742d1b59913922da5aff0', 1003, 1, '北京市海淀区', '18911780491', '', '36073220170191291', '121211211@qq.com', '1910290192', 'lixiaoxiao', '100093', '群众', '0', '本科', '睡觉', '看电视', 'CN', '2017-01-11', '无', '无', '11212', '121212', '哈哈', 0, '3', 101021, 1, '2018-01-23', 11, NULL, NULL, NULL, NULL, '李潇潇', 1),
	('a5032a6ec23a40798448db57e8a5732b', 1002, 2, '黑龙江省哈尔滨市', '13641059864', '', '23012519910701264X', 'lixinxin852@126.com', '931920085', '13641059864', '100019', '党员', '0', '本科', '逛街购物', '跳舞', 'CN', '1991-07-01', '无', '通信工程', '外语能力： 六级\r\n东北石油大学', '1212', '父母联系方式15146409055', 0, '3', 11111, 27, '2018-02-09', 1001, NULL, NULL, NULL, NULL, '李欣欣', 2),
	('c2cc729ffd684f6896a80cd4d02dfb82', 10022052, 2, '河南周口', '15600647138', '', '41272119901102266X', 'zhlee007@gmail.com', '395986883', 'leejenney', '100019', '党员', '0', '本科', '逛街', '唱歌', 'CN', '1990-11-02', '佛教', '软件工程', '中原工学院 \r\n软件工程（java方向）\r\n外语能力： cet-4（501）\r\n是否自备电脑：是', '是否住宿：是', '父母电话 15936913841', 0, '2', 1001, 28, '2018-02-09', 1001, NULL, NULL, NULL, NULL, '李志华', 0),
	('f1c558ce3db2423e8e5dd1566839fe28', 101, 1, '北京市海淀区', '18101298728', '', '360732199306202118', '12811212921@qq.com', '1291290121', 'liuxicai002', '10001', '群众', '3', '本科', '编程', '书法', 'CN', '10919291', '佛教', '计算机科学与技术', 'vvv', '212121212', '哈哈', 0, '1', 975, 23, '2018-01-16', 101, NULL, NULL, NULL, NULL, '刘熙财', 1);
...
CREATE TABLE IF NOT EXISTS `tb_stipendmanager` (
  ...
  `STATUS` int(5) DEFAULT NULL COMMENT '审批状态 1未审批 2 删除 3 通过',
  PRIMARY KEY (`STIPENDMANAGER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='薪酬登记表';

-- 正在导出表  lxcadmin.tb_stipendmanager 的数据：~1 rows (大约)
...
INSERT INTO `tb_stipendmanager` (`STIPENDMANAGER_ID`, `STIPEND_NAME`, `STIPEND_USER_NAME`, `STIPEN_WEAL_JOURNEY`, `STIPEN_WEAL_LUNCH`, `GTIPEND_DATE`, `BASE_STIPEND`, `STIPEND_TYPE`, `STIPEND_WEAL`, `STATUS`) VALUES
	('1001', '软件工程师薪资', '张三', 300, 600, '2018-01-01', '1001', 1001, 10000, 1);
