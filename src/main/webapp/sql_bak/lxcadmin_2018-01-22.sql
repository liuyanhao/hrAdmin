...
-- 正在导出表  lxcadmin.oa_department 的数据：~9 rows (大约)
...
-- 正在导出表  lxcadmin.sys_createcode 的数据：~2 rows (大约)
...
-- 正在导出表  lxcadmin.sys_menu 的数据：~55 rows (大约)
...
-- 正在导出表  lxcadmin.sys_role 的数据：~14 rows (大约)
...
INSERT INTO `sys_role` (`ROLE_ID`, `ROLE_NAME`, `RIGHTS`, `PARENT_ID`, `ADD_QX`, `DEL_QX`, `EDIT_QX`, `CHA_QX`) VALUES
	...
	('c2ae457987fd4704bef5f630583aa6ad', '人力资源系统管理员', '73786413343844589510', '1', '73786413343844589510', '73786413343844589510', '73227720631770931142', '73786413343843573702'),
...
-- 正在导出表  lxcadmin.sys_role_lxcbutton 的数据：~10 rows (大约)
...
INSERT INTO `sys_user` (`USER_ID`, `USERNAME`, `PASSWORD`, `NAME`, `RIGHTS`, `ROLE_ID`, `LAST_LOGIN`, `IP`, `STATUS`, `BZ`, `SKIN`, `EMAIL`, `NUMBER`, `PHONE`) VALUES
	('1', 'admin', '302a0527527647a6dea9ae5dc8ed732ef8d7054a', 'lxc', '1133671055321055258374707980945218933803269864762743594642571294', '1', '2018-01-22 02:04:47', '127.0.0.1', '0', 'admin', 'default', 'QQ1094921525@main.com', '001', '18101298728'),
	...
	('b920e29ae2264f40a6a9530036c732fd', 'hr', '861d10246b852f459de5d6e853db324ec270f270', 'HR', '', 'c2ae457987fd4704bef5f630583aa6ad', '2018-01-22 02:48:59', '127.0.0.1', '0', '人力资源管理员', 'default', '1281290121@qq.com', '1001', '18911780490'),
...
-- 正在导出表  lxcadmin.tb_staffemployee 的数据：~1 rows (大约)
...
INSERT INTO `tb_staffemployee` (`STAFFEMPLOYEE_ID`, `STAFF_ID`, `SEX`, `ADDRESS`, `PHONE`, `PIC`, `CARD_ID`, `EMAIL`, `QQ`, `WECHAT`, `POST_CODE`, `GOVEMMET`, `NATION`, `LEARING`, `HOBBY`, `SUIT`, `NATIONALITY`, `BIRTH`, `FAITH`, `SPEIALITY`, `RESUME`, `DESCRIBES`, `REMARK`, `ISROMVE`, `JOB_ID`, `USER_ID`, `AGE`, `ADD_TIME`, `STIPEND_ID`, `CREATE_TIME`, `UPDATE_TIME`, `CREATE_USER`, `UPDATE_USER`, `STAFF_NAME`, `STATES`) VALUES
	('58d0c83404c447ec94354d044f489897', 1002, 2, '海南岛', '18911780490', 'psb.jpg', '360732199202102113', '212819289@qq.com', '1094921521', '121211214', '3424223', '党员', '汉族', '研究生', '旅游', '绘画', '中国', '1992-02-10', '佛教', '金融', '121212', NULL, '', '在职', 1001, 10002, 26, '2018-01-22', 111, NULL, NULL, NULL, NULL, '古成芳', NULL),
	('f1c558ce3db2423e8e5dd1566839fe28', 101, 1, '北京市海淀区', '18101298728', 'touxiang.jpg', '360732199306202118', '12811212921@qq.com', '1291290121', 'liuxicai002', '10001', '群众', '汉', '本科', '编程', '书法', '中国', '10919291', '佛教', '计算机科学与技术', '哈哈哈', NULL, '哈哈', '11', 1002, 975, 23, '2018-01-16', 101, '2018-01-16', '2018-01-16', '1', '1', '刘熙财', 1);
