		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="subjecttypemx/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="SUBJECTTYPEMX_ID" id="SUBJECTTYPEMX_ID" value="${pd.SUBJECTTYPEMX_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input type="text" name="SUBJECTMANAGE" id="SUBJECTMANAGE" value="${pd.SUBJECTMANAGE}" maxlength="255" placeholder="这里输入试题类型" title="试题类型" style="width:98%;"/></td>
							</tr>
							<tr>
