			...
			<div class="page-content">
				<div class="row">
					...
					<form action="staffemployee/${msg }.do" name="Form" id="Form" method="post">
						...
						<input type="hidden" name="STATES" id="STATES" value="${pd.STATES}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td rowspan="5" colspan="1">
									...
									<input type="file"  id="uploadify1"  keepDefaultStyle = "true" class="hidden"  title="照片地址" style="width:98%;"/>
									</div>
								</td>
							</tr>
							<tr>
								<td style="width:79px;text-align: right;padding-top: 13px;">电话:</td>
								<td><input type="text" name="PHONE" id="PHONE" value="${pd.PHONE}" readonly="readonly" maxlength="11" placeholder="这里输入电话" title="电话" style="width:98%;"/></td>
								<td style="width:79px;text-align: right;padding-top: 13px;">性别:</td>
								<td>
									<select name="SEX" title="性别" disabled="disabled" style="width:98%;">
							...
							<tr>
								...
								<td><input type="text" name="BIRTH" id="BIRTH" class="span10 date-picker"  readonly="readonly" data-date-format="yyyy-mm-dd" readonly="readonly"  value="${pd.BIRTH}" maxlength="20" placeholder="这里输入出生年月" title="出生年月" style="width:98%;"/></td>
								<td style="width:79px;text-align: right;padding-top: 13px;">年龄:</td>
								<td><input type="number"  min="1" name="AGE" id="AGE"  readonly="readonly" value="${pd.AGE}" maxlength="32" placeholder="这里输入年龄" title="年龄" style="width:98%;"/></td>
								<td></td>
							</tr>
							<tr>
								<td style="width:79px;text-align: right;padding-top: 13px;">QQ:</td>
								<td><input type="text" name="QQ" id="QQ" value="${pd.QQ}" maxlength="10"  readonly="readonly" placeholder="这里输入QQ" title="QQ" style="width:98%;"/></td>
								<td style="width:79px;text-align: right;padding-top: 13px;">微信:</td>
								<td><input type="text" name="WECHAT" id="WECHAT" value="${pd.WECHAT}" readonly="readonly" maxlength="30" placeholder="这里输入微信" title="微信" /></td>
								<td></td>
							</tr>
							<tr>
								<td style="width:79px;text-align: right;padding-top: 13px;">国籍:</td>
								<td>
									<select  name="NATIONALITY" id="NATIONALITY" disabled="disabled"  title="国籍" style="width:98%;"></select>
								</td>
								<td style="width:79px;text-align: right;padding-top: 13px;">民族:</td>
								<td><select id="NATION"  class="chosen-select form-control" disabled="disabled"  name ="NATION" title="民族" style="width:98%;"></select></td>
								<td style="width:79px;text-align: right;padding-top: 13px;"><a class="btn btn-mini btn-success hidden" onclick="uploadTouXiang()" >上传</a></td>
							</tr>
							<tr>
								<td style="width:79px;text-align: right;padding-top: 13px;">学历:</td>
								<td><select name="LEARING" id="LEARING" maxlength="10" disabled="disabled" placeholder="这里输入学历" title="学历" style="width:98%;">
								...
								<td><input type="text" name="POST_CODE" id="POST_CODE" value="${pd.POST_CODE}" readonly="readonly"  maxlength="255" placeholder="这里输入邮编号码" title="邮编号码" style="width:98%;"/></td>
								<td style="width:79px;text-align: right;padding-top: 13px;">政治面貌:</td>
								<td>
									<select name="GOVEMMET" id="GOVEMMET"  disabled="disabled" maxlength="15" placeholder="这里选择政治面貌"  title="政治面貌" style="width:98%;">
							...
							<tr>
								...
								<td><input type="text" name="CARD_ID" id="CARD_ID" readonly="readonly" value="${pd.CARD_ID}" maxlength="20" placeholder="这里输入身份证号码" title="身份证号码" style="width:98%;"/></td>
							...
							<tr>
								...
								<td><select name="JOB_TYPE_ID" id="JOB_TYPE_ID" disabled="disabled"  placeholder="这里选择职位分类" onchange="jobType()" title="职位分类" style="width:98%;">
									<c:choose>
								...
								<td><select name="JOB_ID" id="JOB_ID" value="${pd.JOB_ID}" maxlength="32" disabled="disabled" placeholder="这里输入职位名称" title="职位名称" style="width:98%;">
									<option value="">请选择</option>
								</select>
								</td>
								<td style="width:79px;text-align: right;padding-top: 13px;">登记时间:</td>
								<td><input class="span10 date-picker" readonly="readonly" name="ADD_TIME" id="ADD_TIME" value="${pd.ADD_TIME}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="登记时间" title="登记时间" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:79px;text-align: right;padding-top: 13px;" >地址:</td>
								<td colspan="6" ><input type="text" name="ADDRESS" id="ADDRESS" value="${pd.ADDRESS}" readonly="readonly" maxlength="50" placeholder="这里输入地址" title="地址" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:79px;text-align: right;padding-top: 13px;">备注:</td>
								<td colspan="6">
									<textarea rows="5" name="REMARK" id="REMARK"  maxlength="255" placeholder="这里输入备注" readonly="readonly" title="备注" style="width:98%;">${pd.REMARK}</textarea>
								</td>
							</tr>
							<tr height="50px">
								<td style="width:79px;text-align: right;padding-top: 13px;">个人简历:</td>
								<td colspan="6" >
									<textarea rows="10" name="RESUME" id="RESUME"  maxlength="255" readonly="readonly" placeholder="这里输入个人简历" title="个人简历" style="width:98%;"/>${pd.RESUME}</textarea>
								</td>
							</tr>
							...
							<tr height="50px">
								...
								<td colspan="6">
									<textarea rows="10" name="DESCRIBES" id="DESCRIBES" maxlength="255"  readonly="readonly" placeholder="这里输入个人描述" title="个人描述" style="width:98%;"/>${pd.DESCRIBES}</textarea>
								</td>
							</tr>
							<tr>
