					...
					<form action="resume/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><select  name="NATIONALITY" id="NATIONALITY"   disabled="disabled" title="国籍"></select>	</td>
							...
							<tr>
								...
								<td><input class="span10 date-picker" name="TIME"  readonly="readonly"  id="TIME" value="${pd.TIME}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="时间" title="时间" style="width:98%;"/></td>
							...
							<tr>
								...
								<td>
									<select name="JOB_MESSAGE_ID" id="JOB_MESSAGE_ID"  readonly="readonly" style="width:98%;">
										<option value=""></option>
									</select>
								</td>
							</tr>
							<tr>
								...
								<td><input type="number" name="RESULT" id="RESULT"  readonly="readonly"  value="${pd.RESULT}" maxlength="32" placeholder="这里输入面试成绩" title="面试成绩" style="width:98%;"/></td>
							...
							<tr>
								...
								<td colspan="5" >
									<textarea rows="10" name="RESUME" id="RESUME"  readonly="readonly"   placeholder="这里输入个人简历" title="个人简历" style="width:98%;"/>${pd.RESUME}</textarea>
								</td>
							</tr>
							<tr>
